...
class ApprenticesControllerTest < ActionController::TestCase
  ...
  test "should create apprentice" do
    assert_difference('Apprentice.count') do
      post :create, apprentice: { city: @apprentice.city, master_id: @apprentice.master_id, master_name: @apprentice.master_name, name: @apprentice.name }
    end
  ...
  test "should update apprentice" do
    patch :update, id: @apprentice, apprentice: { city: @apprentice.city, master_id: @apprentice.master_id, master_name: @apprentice.master_name, name: @apprentice.name }
    assert_redirected_to apprentice_path(assigns(:apprentice))
  end
