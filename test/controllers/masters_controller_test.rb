...
class MastersControllerTest < ActionController::TestCase
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post :create, master: { city: @master.city, domain: @master.domain, name: @master.name, state: @master.state }
    end
  ...
  test "should update master" do
    patch :update, id: @master, master: { city: @master.city, domain: @master.domain, name: @master.name, state: @master.state }
    assert_redirected_to master_path(assigns(:master))
  end
